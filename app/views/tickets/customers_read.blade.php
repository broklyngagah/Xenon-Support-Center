    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body" style="height:292px;overflow: auto;">
        ...
        <div class="col-lg-9" style="margin-bottom: 20px;">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    {{Form::open(['url'=>'/tickets/customer/update','method'=>'post','files'=>true,'id'=>'reply_submit'])}}
                    ...
                    <input type="hidden" name="user_id"
                           value="{{\KodeInfo\Utilities\Utils::isBackendUser(Auth::user()->id)?$thread->operator_id:$thread->sender_id}}"/>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var user_id = {{\KodeInfo\Utilities\Utils::isBackendUser(Auth::user()->id)?$thread->operator_id:$thread->sender_id}}
